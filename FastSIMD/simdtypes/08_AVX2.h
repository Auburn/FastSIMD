...
struct AVX2_f32x4
{
    FASTSIMD_VECTOR_TYPE_SET(AVX2_f32x4, __m256);
...
FASTSIMD_VECTOR_OPERATORS_FLOAT(AVX2_f32x4)


struct AVX2_i32x4
{
    FASTSIMD_VECTOR_TYPE_SET(AVX2_i32x4, __m256i);
...
FASTSIMD_VECTOR_OPERATORS_INT(AVX2_i32x4)
